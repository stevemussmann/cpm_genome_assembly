...
my_species <- c('Brain', 'Brain', 'Brain', 'Brain', 'Eye', 'Eye', 'Eye', 'Eye', 'Gall Bladder', 'Gall Bladder', 'Gall Bladder', 'Gall Bladder', 'Gill', 'Gill', 'Gill', 'Gill', 'Heart', 'Heart', 'Heart', 'Heart', 'Kidney', 'Kidney', 'Kidney', 'Kidney', 'Liver', 'Liver', 'Liver', 'Liver', 'Muscle', 'Muscle', 'Muscle', 'Muscle', 'Skin', 'Skin', 'Skin', 'Skin', 'Spleen', 'Spleen', 'Spleen', 'Spleen', 'Testes', 'Testes', 'Testes', 'Testes')
...
my_percentage <- c(80.6, 1.6, 2.6, 15.2, 79.1, 2.2, 3.6, 15.1, 79.4, 1.9, 3.0, 15.7, 79.2, 1.9, 2.9, 16.0, 74.4, 1.8, 3.3, 20.5, 81.9, 1.8, 2.5, 13.8, 64.1, 1.3, 5.0, 29.6, 50.2, 1.2, 6.0, 42.6, 80.1, 1.6, 2.4, 15.9, 75.9, 1.7, 3.3, 19.1, 86.0, 2.1, 3.1, 8.8)
my_values <- c(2935, 57, 94, 554, 2879, 79, 132, 550, 2890, 69, 110, 571, 2882, 68, 105, 585, 2707, 67, 119, 747, 2981, 64, 92, 503, 2332, 48, 182, 1078, 1829, 44, 220, 1547, 2917, 58, 86, 579, 2762, 63, 119, 696, 3131, 78, 113, 318)
...
ggsave(figure, file=my_output, width = my_width, height = my_height, unit = my_unit, dpi = 600)
print("Done")
